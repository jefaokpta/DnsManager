<%-- 
    Document   : createServer
    Created on : 02/07/2014, 18:15:35
    Author     : jefaokpta
--%>
...
<html>
    ...
    <body>
        <div id="container" class="container">
            <form id="frm" action="CreateServer" method="POST">
                   <fieldset>
                    <legend><em>Novo Servidor</em></legend>
                    <h4>Nome do Servidor</h4>
                    <input type="text" id="name" name="name"/>
                    <h4>IP do Servidor</h4>
                    <input id="ip" type="text" name="ip" onkeypress ="return ( maskIP(event,this) );" 
