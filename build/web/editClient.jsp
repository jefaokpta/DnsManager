<%-- 
    Document   : editClient
    Created on : 13/08/2014, 14:53:16
    Author     : jefaokpta
--%>
...
<html>
    ...
    <body>
        <div id="container" class="container">
            <form id="frm" action="EditDns" method="POST">
                   <fieldset>
    ...
    <script>
        var pos=<%=db.countDns(request.getParameter("dns")) %>;
        function addDesc(){
            pos++;
